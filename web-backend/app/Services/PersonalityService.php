...
class PersonalityService
{
    ...
    private const ROLE_PERSONALITIES = [
        'guest' => [
            ...
            'system_prompt_addition' => 'Be welcoming and informative. Encourage them to register for better personalized service.',
        ],
        'client' => [
            ...
            'system_prompt_addition' => 'Be helpful and proactive. Address their specific needs based on their appointment history.',
        ],
        'admin' => [
            'tone' => 'professional',
            'formality' => 'formal',
            ...
            'system_prompt_addition' => 'Provide detailed system information and analytics. Suggest optimizations based on data.',
        ],
        'cashier' => [
            'tone' => 'professional',
            'formality' => 'professional',
    ...
    private const SENTIMENT_ADJUSTMENTS = [
        ...
        'very_negative' => [
            'enthusiasm' => 'very_low',
            'emoji_friendly' => false,
            'tone_override' => 'apologetic-empathetic',
            'response_length' => 'extended',
            'extra_support' => true,
