    ...
    private array $languagePatterns = [
        'tl' => [ // Tagalog/Filipino
            'keywords' => [
                ...
                // Taglish and slang
                'di', 'diko', 'hindi ko', 'naman', 'kaya', 'ayaw', 'gumagana',
                'yung', 'yan', 'yon', 'yung sinabi', 'yung araw',
                'pano', 'kelan', 'saang', 'gets', 'gets ko', 'di ko gets',
                'teh', 'bestie', 'sis', 'bro', 'pare', 'amiga', 'astig',
                'sali', 'seryoso', 'trip', 'lagi', 'dami', 'ganda', 'galing',
                'nag', 'naging', 'nagsimula', 'napunta', 'nalagay', 'nagaan',
                'pls', 'plz', 'puh', 'puh leaze', 'please', 'thankss', 'thanks',
                'help', 'tulong', 'sabi', 'sinabi', 'issue', 'problema',
            ],
            'patterns' => [
                ...
                // Taglish patterns
                '/\byung\s+\w+/i',
                '/\b(di|hindi)\s+(ko|mo|niya|namin|natin|ninyo|nila)\b/i',
                '/\b(gets|naintindihan|maintindihan)\b/i',
                '/\b(pano|paano)\s+(ka|mo|ba)\b/i',
                '/\b(kelan|kailan)\s+(ba|na|pa)\b/i',
                '/\b(ayaw|gusto|kaya|makaya)\b/i',
            ],
            'weight' => 1.5,
        ],
        'en' => [ // English
