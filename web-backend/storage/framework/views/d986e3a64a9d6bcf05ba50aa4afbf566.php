        ...
        <div class="content">
            ...
            <?php if($appointment->status === 'declined' && $appointment->decline_reason): ?>
                <div class="decline-reason">
                    ...
                    <div class="reason-text"><?php echo e($appointment->decline_reason); ?></div>
                </div>
            <?php endif; ?>
            
            <?php if($appointment->staff_notes): ?>
                <div class="notes-section">
                    <div class="notes-label">Additional Notes:</div>
                    <div class="notes-text"><?php echo e($appointment->staff_notes); ?></div>
                </div>
            <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\web\web-backend\resources\views/emails/appointment-status.blade.php ENDPATH**/ ?>